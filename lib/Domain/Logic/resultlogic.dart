...
class ResultLogic {
  ...
  /// Método adicional para obtener el texto del resultado clasificado en bajo riesgo o alto riesgo.
  ///
  /// Retorna 'Bajo riesgo' si el valor es menor o igual a 120, de lo contrario, retorna 'Alto riesgo'.
  String getClassifiedResult(int resultadoValue) {
    return resultadoValue == 0 ? 'Bajo riesgo' : 'Alto riesgo';
  }
}
