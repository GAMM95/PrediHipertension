...
class CustomDropDown extends StatefulWidget {
  ...
  final String? defaultValue;
  final TextEditingController? controller;
  final ValueChanged<String?>? onChanged; // Añadimos la propiedad onChanged
  ...
  const CustomDropDown({
    ...
    this.defaultValue,
    this.controller,
    this.onChanged, // Añadimos la propiedad onChanged al constructor
  });
        ...
        onChanged: (String? newValue) {
          if (newValue != null) {
            ...
            if (widget.onChanged != null) {
              widget.onChanged!(newValue); // Llamamos a onChanged si no es null
            }
          }
        },
      ),
